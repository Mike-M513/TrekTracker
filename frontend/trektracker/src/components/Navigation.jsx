  ...
  return (
    <Navbar bg="dark" className="treknav">
      <Container>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-backpack3" viewBox="0 0 16 16">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <NavDropdown title="Trakker" id="collapsible-nav-dropdown">
              <NavDropdown.Item href="#action/3.1">Add Park</NavDropdown.Item>
